...
2. The rules exist physically and natively inside the host project (`docs/agent/troubleshooting.md`), completely visible to AIs.
...
If you modify `docs/agent/troubleshooting.md` inside a host project and want to publish that discovery here—or if you want to pull the newest global rules from here down into your host project—you must use `git subtree`.

### Pulling the Latest Constraints (Syncing Down)
Run this inside your host project's root directory:
```bash
git subtree pull --prefix=docs git@github.com:Performant-Labs/ai_guidance.git main --squash
```
...
```bash
git subtree push --prefix=docs git@github.com:Performant-Labs/ai_guidance.git main
```
...
alias ai:sync="git subtree pull --prefix=docs git@github.com:Performant-Labs/ai_guidance.git main --squash"
alias ai:push="git subtree push --prefix=docs git@github.com:Performant-Labs/ai_guidance.git main"
```
